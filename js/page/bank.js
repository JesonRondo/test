define(function(require, exports, module) {
    ...
    var createCostlist = function() {
        ...
        lis.push('<input type="radio" name="cost" class="pay-list-radio" id="cost-custom" />');
        lis.push('<label for="cost-custom">其他</label>');
        lis.push('<input type="text" name="cost-custom-text" id="cost-custom-text" class="pay-list-text" />');
    ...
    var createBanklist = function() {
        ...
        for (var i = 0, len = banklist.length; i < len; i++) {
            ...
            lis.push('<input type="radio" name="bank" class="pay-list-radio" id="bank-' + banklist[i].bankid + '" />');
